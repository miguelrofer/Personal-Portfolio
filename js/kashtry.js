...
var exp = state.concat(str1);
console.log(exp);
var imp = state.concat(str2);
console.log(imp);
...
var area = d3.area()
  ...
  .y1(function(d) { return y(Math.max(d.exp, d.imp)); });
...
d3.csv("data/maindata.csv", function(error, data) {
...
var countries = ['Belgium',	'Bulgaria',	'CzechRepublic',	'Denmark',	'Germany ',	'Estonia',	'Ireland',	'Greece',	'Spain',	'France',	'Croatia',	'Italy',	'Cyprus',	'Latvia',	'Lithuania',	'Luxembourg',	'Hungary',	'Malta',	'Netherlands'];

differencechart(countries[0]);
